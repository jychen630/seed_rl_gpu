...
def run_experiment(K=100, ensemble_size=30):
    ...
    # NumPy doesn't use GPU by default, so we'll set this to 0
    gpu_per_agent = 0
...
def save_metrics_to_csv(metrics_list, filename='cartpole_numpy_measure.csv'):
...
if __name__ == '__main__':
    ...
    print("\nMetrics saved to cartpole_numpy_measure.csv")
